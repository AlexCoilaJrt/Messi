...
//guardarButton.setToolTipText("MODIFICAR");
    ...
    private void initComponents() {
        ...
        txtNombres.add(contrato, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 380, -1, -1));
    ...
    private void runReport1(String Contrato) {
        try {
            Connection = Conn.connectSQLite();
            HashMap param = new HashMap();
            param.put("idcliente", Contrato);
            JasperDesign jdesign = JRXmlLoader.load(getFile("contrato.jrxml"));
...
//CAMINO = Paths.get(ruta+"/"+"reporte1.jrxml");
        Path CAMINO = Paths.get(ruta + "/" + ruta);
